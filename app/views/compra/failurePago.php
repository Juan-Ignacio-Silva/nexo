    ...
    <style>
        * {
        ...
        .success-icon {
            ...
            height: 80px;
            margin: 0 auto 30px;
            background: linear-gradient(135deg, #c71b29ff 0%, #c71b29ff 100%);
            border-radius: 50%;
            display: flex;
            justify-content: center;
            align-items: center;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <h1>¡Pago Fallido!</h1>
            <p>Tu transacción ha sido cancelada. Vuelve a intentar a realizar el proceso de pago.</p>
            <div class="button-group">
                <a href="<?= BASE_URL ?>home" class="btn btn-secondary">Volver a la tienda</a>
                <a href="<?= BASE_URL ?>productos/carrito" class="btn btn-primary">Volver al carrito</a>
            </div>
        </div>
    </div>
</body>
